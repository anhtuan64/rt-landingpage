	...
	<div id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-content">
				<?php 
					if ( !is_front_page() ) {
						echo '<div class="fusion-title title"><h3 class="title-heading-left" data-fontsize="16" data-lineheight="24">'. get_the_title() .'</h3><div class="title-sep-container"><div class="title-sep sep-single sep-solid"></div></div></div>';
					}
				?>
				<?php the_content(); ?>
